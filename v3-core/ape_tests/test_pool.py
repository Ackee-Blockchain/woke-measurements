...
class TestMint:
    ...
    class TestAfterInitialization:
        @pytest.fixture(scope="function")
        def initialized_pool_fixture(self, project, accounts, pool_fixture):
            token0, token1, factory, pool, pool_helper = pool_fixture
        ...
        class TestSuccessCases:
            def test_initial_balances(self, accounts, initialized_pool_fixture):
                """
                Initial balances
                """
                token0, token1, factory, pool, pool_helper = initialized_pool_fixture
            ...
            def test_initial_tick(self, accounts, initialized_pool_fixture):
                """
                Initial tick
                """
                token0, token1, factory, pool, pool_helper = initialized_pool_fixture
